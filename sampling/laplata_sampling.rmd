...
library(rgdal)
library(knitr)
input_path <- setwd("C:/Users/einav/Desktop/Thesis data/La Plata")
...
1. Proportionately allocated strata in the built up area - a sample of 95 building rooftops
2. Proportionately allocated strata in the non built up area - a sample of 5 building rooftops.
